...
class Summoner(Base):
    ...
    solo_loses = Column(Integer, default=0)
    solo_point = Column(Integer, default=0)
    flex_tier = Column(String(50), default="")
    flex_lp = Column(Integer, default=0)
    flex_wins = Column(Integer, default=0)
    flex_loses = Column(Integer, default=0)
    flex_point = Column(Integer, default=0)
    most1 = Column(String(50), default="")
    most2 = Column(String(50), default="")
    most3 = Column(String(50), default="")
